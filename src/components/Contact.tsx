        ...
        >
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-on-surface/5 text-on-surface hover:bg-on-surface hover:text-white hover:scale-105 active:scale-95 transition-all duration-200"
              title="View Resume"
            >
