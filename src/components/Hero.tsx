  ...
  return (
    <main id="hero" className="relative min-h-[calc(100vh-72px)] net-box-grid overflow-hidden">
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="max-w-[1440px] mx-auto px-margin-mobile pt-5 pb-20 flex flex-col md:flex-row md:items-center md:px-margin-desktop md:pt-10 gap-10"
      >
        {/* Left Column: Identity */}
        <motion.div variants={itemVariants} className="flex-1 z-10 space-y-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-on-surface-variant/70">
              <span className="material-symbols-outlined text-sm">location_on</span>
              <span className="font-geist-mono text-[14px]">Sipalay City Negros Occidental Philippines</span>
            </div>
            <h1 className="font-plus-jakarta text-[48px] md:text-[72px] font-extrabold text-primary leading-none tracking-tighter">
              Andrew Lloyd E. Polidario
            </h1>
            <p className="font-plus-jakarta text-[32px] md:text-[40px] text-on-surface font-bold">
              Full-Stack Developer
            </p>
            <div className="w-16 h-1 bg-primary rounded-full"></div>
          </div>
          <p className="text-on-surface-variant max-w-md leading-relaxed text-[18px]">
          ...
          <div className="flex items-center gap-8 pt-6">
            <SocialButton 
              ...
              icon={<img src={linkedinIcon} alt="LinkedIn" className="w-10 h-10 object-contain" />} 
              label="LinkedIn"
              title="LinkedIn"
            ...
            <SocialButton 
              ...
              icon={<img src="https://cdn.simpleicons.org/github/181717" alt="GitHub" className="w-10 h-10 object-contain" />} 
              label="GitHub"
              title="GitHub"
        ...
        <motion.div 
          ...
          className="flex-1 relative min-h-[400px] flex items-center justify-center md:min-h-[600px]"
        >
          {/* Background Glowing Orbs */}
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-primary/20 rounded-full blur-[100px] animate-pulse-glow"
            style={{ transform: `translate(calc(-50% + ${mousePos.x * 0.5}px), calc(-50% + ${mousePos.y * 0.5}px))` }}
          ></div>
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-secondary/20 rounded-full blur-[80px] animate-pulse-glow"
            style={{ 
              animationDelay: '1.5s',
          ...
          <div className="relative w-full max-w-[450px] z-10 group flex items-center justify-center">
            {/* Main Portrait */}
